      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center text-dark/75">
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24">
            ...
            <div className="cols-span-6">Project-1</div>
            <div className="cols-span-6">Project-2</div>
            <div className="col-span-12">Featured Project</div>
            <div className="cols-span-6">Project-3</div>
            <div className="cols-span-6">Project-4</div>
          </div>
        </Layout>
      </main>
    </>
